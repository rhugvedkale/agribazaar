        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="section-title" data-aos="fade-right">
              <h2>Customer Login/Register</h2>
              <p>Login as Customer/Buyer -<br>Buy any agricultural produce you like! </b></p>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="row">
              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="100" style="width: 100%;">
				  ...
				  <button type="button" class="btn btn-info btn-lg btn-block" onclick="window.location='customerloginpanel.php'">Login</button>
                </div>
              </div>
              ...
              <div class="col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200" style="width: 100%;">
				  ...
				  <button type="button" class="btn btn-warning btn-lg btn-block"  onclick="window.location='customerReg.php'" >Register</button>
                </div>
              </div>
