...
<head>
  ...
  <title>AgriBazaar - Agriculture Management System</title>
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>AGRI-BAZAAR</span></a></h1>
        </div>
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li class=" <?php
                            ...
                            ?>"><a href="displayproducts.php" onclick='window.location=`displayproducts.php`' >Tools</a>
              <!-- <ul>
<?php
...
?>
			...
			<li class="drop-down <?php
                            ...
                            ?>"><a href="displaysales.php" onclick='window.location=`displaysales.php`'>Buy Products</a>
              <ul>
<?php
...
<li class="drop-down <?php
  ...
  <ul>
	...
	<li><a href="viewcstpurchasereport.php">Tools Purchase Report</a></li>					
  ...
  <ul>
	...
	<li class="drop-down"><a href="#">Report</a>
	  <ul>
		...
		<li><a href="viewadminpurchasereport.php">Tools Billing Report</a></li>
	  </ul>
	</li>
...
<li><a href="viewProduce.php">View Produce types</a></li>       
	...
	<li class="drop-down"><a href="#">Add/View Tools</a>
	  <ul> 
		<li><a href="sellingproduct.php">Add  Tools</a></li>
		<li><a href="viewsellingproduct.php">View  Tools</a></li>
	  </ul>
	</li>
